...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RootDestination.MainNavigation")))
@interface SharedRootDestinationMainNavigation : SharedRootDestination
@property (class, readonly, getter=shared) SharedRootDestinationMainNavigation *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)mainNavigation __attribute__((swift_name("init()")));
- (SharedRootEntry *)createComponentComponentContext:(id<SharedComponentContext>)componentContext __attribute__((swift_name("createComponent(componentContext:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("RootEntry.MainAppNavigation")))
@interface SharedRootEntryMainAppNavigation : SharedRootEntry
@property (class, readonly, getter=shared) SharedRootEntryMainAppNavigation *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)mainAppNavigation __attribute__((swift_name("init()")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
