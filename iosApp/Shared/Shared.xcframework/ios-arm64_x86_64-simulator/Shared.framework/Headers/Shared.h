...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("HomescreenViewModel")))
@interface SharedHomescreenViewModel : SharedSharedViewModel<SharedHomescreenViewState *, SharedKotlinNothing *>
@property (readonly) id<SharedKotlinx_coroutines_coreMutableStateFlow> viewState __attribute__((swift_name("viewState")));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@end
