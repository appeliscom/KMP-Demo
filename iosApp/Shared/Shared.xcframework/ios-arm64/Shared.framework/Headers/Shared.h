...
@required
- (void)navigateToCategory __attribute__((swift_name("navigateToCategory()")));
@end
...
@property (class, readonly, getter=shared) SharedMainFlowDestinationCategory *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
