...
// Source: wallet_v2/wallet.data.v2.proto
//
...
public enum Metro_Wallet_Data_V2_FundActivityType: SwiftProtobuf.Enum {
...
extension Metro_Wallet_Data_V2_FundActivityType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Metro_Wallet_Data_V2_FundActivityType] = [
    .unknownActivityType,
    .credited,
    .spending,
    .expiration,
...
public enum Metro_Wallet_Data_V2_WalletFundType: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Metro_Wallet_Data_V2_WalletFundType: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Metro_Wallet_Data_V2_WalletFundType] = [
    .unknownFundType,
    .mania,
  ]
}
...
public enum Metro_Wallet_Data_V2_SpendResultError: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Metro_Wallet_Data_V2_SpendResultError: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Metro_Wallet_Data_V2_SpendResultError] = [
    .unknownSpendResult,
    .insufficientFunds,
    .businessNotFound,
    .fundNotFound,
...
public enum Metro_Wallet_Data_V2_SpendingReportOutputFormat: SwiftProtobuf.Enum {
  public typealias RawValue = Int
...
extension Metro_Wallet_Data_V2_SpendingReportOutputFormat: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Metro_Wallet_Data_V2_SpendingReportOutputFormat] = [
...
public struct Metro_Wallet_Data_V2_FundExpiration {
...
public struct Metro_Wallet_Data_V2_FundActivity {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Metro_Wallet_Data_V2_FundActivityType = .unknownActivityType
...
public struct Metro_Wallet_Data_V2_WalletFund {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var type: Metro_Wallet_Data_V2_WalletFundType = .unknownFundType

  public var name: String = String()

  public var balance: Double = 0

  public var expiration: [Metro_Wallet_Data_V2_FundExpiration] = []
...
public struct Metro_Wallet_Data_V2_WalletOverview {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var funds: [Metro_Wallet_Data_V2_WalletFund] = []
...
public struct Metro_Wallet_Data_V2_SpendResultData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
public struct Metro_Wallet_Data_V2_SpendingsReportRow {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Metro_Wallet_Data_V2_FundActivityType: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_WalletFundType: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_SpendResultError: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_SpendingReportOutputFormat: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_FundExpiration: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_FundActivity: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_WalletFund: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_WalletOverview: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_SpendResultData: @unchecked Sendable {}
extension Metro_Wallet_Data_V2_SpendingsReportRow: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "metro.wallet.data.v2"

extension Metro_Wallet_Data_V2_FundActivityType: SwiftProtobuf._ProtoNameProviding {
...
extension Metro_Wallet_Data_V2_WalletFundType: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Metro_Wallet_Data_V2_SpendResultError: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Metro_Wallet_Data_V2_SpendingReportOutputFormat: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
...
extension Metro_Wallet_Data_V2_FundExpiration: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Metro_Wallet_Data_V2_FundExpiration, rhs: Metro_Wallet_Data_V2_FundExpiration) -> Bool {
...
extension Metro_Wallet_Data_V2_FundActivity: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Metro_Wallet_Data_V2_FundActivity, rhs: Metro_Wallet_Data_V2_FundActivity) -> Bool {
...
extension Metro_Wallet_Data_V2_WalletFund: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Metro_Wallet_Data_V2_WalletFund, rhs: Metro_Wallet_Data_V2_WalletFund) -> Bool {
    if lhs.id != rhs.id {return false}
    if lhs.type != rhs.type {return false}
...
extension Metro_Wallet_Data_V2_WalletOverview: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularDoubleField(value: &self.totalBalance) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if self.totalBalance != 0 {
      try visitor.visitSingularDoubleField(value: self.totalBalance, fieldNumber: 1)
    }
  ...
  public static func ==(lhs: Metro_Wallet_Data_V2_WalletOverview, rhs: Metro_Wallet_Data_V2_WalletOverview) -> Bool {
...
extension Metro_Wallet_Data_V2_SpendResultData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Metro_Wallet_Data_V2_SpendResultData, rhs: Metro_Wallet_Data_V2_SpendResultData) -> Bool {
...
extension Metro_Wallet_Data_V2_SpendingsReportRow: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Metro_Wallet_Data_V2_SpendingsReportRow, rhs: Metro_Wallet_Data_V2_SpendingsReportRow) -> Bool {
