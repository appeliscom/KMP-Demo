...
public struct Metro_Wallet_Private_V1_AddCreditedActivityRequest {
  ...
  public var fundType: Metro_Wallet_Data_V1_WalletFundType = .unknownFundType
...
public struct Metro_Wallet_Private_V1_AddCreditedActivityResponse {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var error: Metro_Wallet_Private_V1_AddCreditedActivityResponse.Error {
  ...
  fileprivate var _error: Metro_Wallet_Private_V1_AddCreditedActivityResponse.Error? = nil
}

#if swift(>=4.2)

extension Metro_Wallet_Private_V1_AddCreditedActivityResponse.Error: CaseIterable {
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  public static let allCases: [Metro_Wallet_Private_V1_AddCreditedActivityResponse.Error] = [
    .unknownError,
...
extension Metro_Wallet_Private_V1_AddCreditedActivityRequest: @unchecked Sendable {}
extension Metro_Wallet_Private_V1_AddCreditedActivityResponse: @unchecked Sendable {}
extension Metro_Wallet_Private_V1_AddCreditedActivityResponse.Error: @unchecked Sendable {}
#endif  // swift(>=5.5) && canImport(_Concurrency)

// MARK: - Code below here is support for the SwiftProtobuf runtime.

fileprivate let _protobuf_package = "metro.wallet.private.v1"

extension Metro_Wallet_Private_V1_AddCreditedActivityRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 7: try { try decoder.decodeSingularUInt32Field(value: &self.amount) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.amount != 0 {
      try visitor.visitSingularUInt32Field(value: self.amount, fieldNumber: 7)
    }
  ...
  public static func ==(lhs: Metro_Wallet_Private_V1_AddCreditedActivityRequest, rhs: Metro_Wallet_Private_V1_AddCreditedActivityRequest) -> Bool {
...
extension Metro_Wallet_Private_V1_AddCreditedActivityResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static func ==(lhs: Metro_Wallet_Private_V1_AddCreditedActivityResponse, rhs: Metro_Wallet_Private_V1_AddCreditedActivityResponse) -> Bool {
...
extension Metro_Wallet_Private_V1_AddCreditedActivityResponse.Error: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
